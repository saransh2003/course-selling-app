...
function CourseCreate() {
	...
	const handleCreateCourse = async (e) => {
		...
		try {
			...
			toast.success(response.data.message || "Front: Course Created Successfully");
			...
			console.log(error);
			toast.error(error.response?.data?.errors || "Front: Failed to Create Course");
		}
	};
	return (
		<div>
			<div className="min-h-screen  py-10">
				<div className="max-w-4xl mx-auto p-6 rounded-lg shadow-lg">
					...
					<form onSubmit={handleCreateCourse} className="space-y-6 mb-8">
						...
						<button type="submit" className="w-full py-3 px-4 cursor-pointer bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors duration-200">
							Create Course
						</button>
					</form>
